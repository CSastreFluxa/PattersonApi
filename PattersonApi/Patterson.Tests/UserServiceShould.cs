...
namespace Patterson.Tests
{
    public class UserServiceShould
    {
        ...
        public async Task GetAllUsers()
        {
            ...
            var expectedResult = GetUsersData();
        ...
        public async Task GetUser()
        {
            ...
            var result = await userService.GetUserAsync(Guid.Parse("3fa85f64-5717-4562-b3fc-2c963f66afa6"));

            var expectedResult = GetUserData();
